...
from model.classifierModule import CAFOClassifier
    ...
    with torch.inference_mode():
        with torch.amp.autocast(device_type="cuda",
            ...
            for batch in dataloader:
                ...
                logits = model(batch)                          # possibly bf16/fp16
...
def main(config_file):
    ...
    dm = CAFODataModule(
        ...
        resize=(720, 720),         # change to (224,224) later if you want more speed
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config_file', default="config/config_fold1_v2.yaml")
