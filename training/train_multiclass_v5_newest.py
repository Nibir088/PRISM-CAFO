...
def main(config_file):
    ...
    if getattr(trainer, "is_global_zero", True):
        ...
        path = f"resultsv4/{cfg['model_name']}/{cfg['data_type']}"
        os.makedirs(path, exist_ok=True)

        output_path = f"resultsv4/{cfg['model_name']}/{cfg['data_type']}/spatial_{cfg['use_spatial_attn']}_pool_{cfg['use_attn_pooling']}_evidence_{cfg['use_evidence_map']}_component_{cfg['use_component_pool']}_confgap_{cfg['use_conf_gap']}_relfeature_{cfg['use_rel_feats']}_freeze_{cfg['freeze_model']}.json"
