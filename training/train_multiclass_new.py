...
# from model.multiclassifierModel_new import CAFOClassifier
    ...
    with torch.inference_mode():
        with torch.amp.autocast(device_type="cuda",
            ...
            for batch in dataloader:
                ...
                logits = model(x)                          # possibly bf16/fp16
...
def main(config_file):
    ...
    dm = CAFODataModule(
        ...
        resize=(224, 224),         # change to (224,224) later if you want more speed
        ...
        val_ratio=0.15,
        drop_last=False,
        collate_train_mode="cls",  # default is "cls" (minimal)
        collate_eval_mode="cls",
        # channels_last=False,
    )
    ...
    if getattr(trainer, "is_global_zero", True):
        ...
        output_path = f"resultsv2/{cfg['data_type']}_{cfg['model_name']}_results.json"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config_file', default="config/config_fold1.yaml")
