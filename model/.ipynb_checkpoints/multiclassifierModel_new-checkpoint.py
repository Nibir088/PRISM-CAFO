...
class CAFOClassifier(pl.LightningModule):
    def __init__(self, num_classes=6, lr=1e-4, model_name='resnet18', freeze_backbone=False):
        super().__init__()
        ...
        if model_name == 'resnet18':
            ...
            self.classifier_head = self.backbone.fc
        ...
        #     self.backbone.heads = nn.Linear(self.backbone.heads.in_features, num_classes)
            ...
            self.backbone = timm.create_model('vit_base_patch16_384', pretrained=True, num_classes=num_classes)
            ...
            self.classifier_head = self.backbone.classifier[2]
            ...
            head = nn.Linear(model.visual.output_dim, num_classes)
